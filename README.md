...
**129 tools** across 14 groups. Call `dexe_proposal_catalog` at runtime for the full proposal-type map, or browse the [catalog](#tool-catalog) below.
...
- [`docs/TOOLS.md`](https://github.com/edward-arinin-web-dev/dexe-mcp/blob/main/docs/TOOLS.md) — complete catalog of all 129 tools, organized by category, with one-line descriptions and required envs per tool.
...
| IPFS | 9 | Pinata uploads (file/avatar/metadata + smart update), deterministic identicon generator, gateway fetch, CID computation |
...
Total: **129**. Per-tool descriptions, args, return shapes → [`docs/TOOLS.md`](https://github.com/edward-arinin-web-dev/dexe-mcp/blob/main/docs/TOOLS.md).
